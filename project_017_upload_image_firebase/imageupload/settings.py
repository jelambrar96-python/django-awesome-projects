...
environ.Env.read_env(path_env_file)

SECRET_KEY = env('DJANGO_SECRET_KEY')
FIREBASE_BUCKET_NAME = env('FIREBASE_BUCKET_NAME')
FIREBASE_CREDENTIALS_FILE = env('FIREBASE_CREDENTIALS_FILE', default='firebase_credentials.json')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = env('DJANGO_DEBUG').lower() in ['true', '1']
